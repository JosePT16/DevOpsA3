...
This project demonstrates a complete CI workflow using Jenkins, including environment setup, quality gates, automated testing with coverage enforcement, and build artifact generation.